...
model = dict(
    ...
    roi_head=dict(
        type='CascadeROITransRoIHead',
        rbbox_stages_num=2,
        rbbox_stage_loss_weight=[1, 0.5],
...
test_cfg = dict(
    ...
    rcnn=dict(
        ...
        # TODO: py_cpu_nms_poly_fast
        score_thr=0.01, nms=dict(type='py_cpu_nms_poly_fast', iou_thr=0.5), max_per_img=200)
)
